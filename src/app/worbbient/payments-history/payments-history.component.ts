...
export class PaymentsHistoryWorbbientComponent extends AppComponentBase implements AfterViewInit {
    ...
    menu: UserMenu = new UserMenu("UserMenu", "UserMenu", [
        ...
        new UserMenuItem("PostTask", "Pages.Worbbient.PostTask", "Worbbient", "", "/post-task"),
        ...
        new UserMenuItem("ViewProfile", "Pages.Worbbior.EditProfile", "Worbbior", "", "/publico/worbbior/page/", this._appSessionService.worbbiorSlug ? this._appSessionService.worbbiorSlug : ""),
    ]);
