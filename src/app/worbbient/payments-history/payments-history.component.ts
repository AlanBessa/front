...
export class PaymentsHistoryWorbbientComponent extends AppComponentBase implements AfterViewInit {
    ...
    menu: UserMenu = new UserMenu("UserMenu", "UserMenu", [
        ...
        new UserMenuItem("ViewProfile", "Pages.Worbbior.EditProfile", "Worbbior", "", "/worbbior/page/", this._appSessionService.worbbiorSlug ? this._appSessionService.worbbiorSlug : ""),
    ]);
