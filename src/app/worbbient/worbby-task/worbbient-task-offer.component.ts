...
@Component({
    templateUrl: './worbbient-task-offer.component.html',
    animations: [appModuleAnimation()]
})
export class WorbbientTaskOfferComponent extends AppComponentBase implements AfterViewInit {
    ...
    updateWorbbyOffer():void{
        this._worbbyTaskService.getWorbbyOffer(this.worbbyOfferId).subscribe(result => {
            ...
            this.scheduleDateDisplay = result.worbbyTask.scheduledDate ? moment(result.worbbyTask.scheduledDate).format('DD/MM/YYYY') : this.scheduleDateDisplay;
    ...
    sendMessage():void {
        ...
        if(!this.isNullOrEmpty(msg.trim())){
            ...
            worbbyMessage.targetUserId = this.worbbyOffer.userId;
