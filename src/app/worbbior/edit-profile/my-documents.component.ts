...
import { FileDtoBase64, FileDto, UserDocumentsInfoServiceProxy, CreateUserDocumentsInfoInputWorbbiorState, CreateUserDocumentsInfoInput, CreateBankAccountInput, BankAccountServiceProxy, ListResultDtoOfBankAccountType, BankAccountType } from '@shared/service-proxies/service-proxies';
...
export class MyDocumentsWorbbiorComponent extends AppComponentBase implements AfterViewInit {
    ...
    changeBank(value: number): void {
        this.userBankAccount.bankAccountTypeId = value;
    }
    ...
    bankAccountIsEmpty(): boolean {
        ...
        if (
            ...
            (this.userBankAccount.bankAccountTypeId == 0 || this.userBankAccount.bankAccountTypeId == undefined) &&
