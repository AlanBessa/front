        ...
        RouterModule.forChild([
            {
                ...
                children: [
                    ...
                    { path: 'register/:roleName', redirectTo: 'registrar/:roleName', pathMatch: 'full', },
                    {
                    ...
                    { path: 'forgot-password', redirectTo: 'esqueceu-a-sua-senha', pathMatch: 'full' },
                    ...
                    { path: 'reset-password', redirectTo: 'trocar-senha', pathMatch: 'full' },
                    ...
                    { path: 'email-activation', redirectTo: 'ativacao-de-email', pathMatch: 'full' },
                    ...
                    { path: 'confirm-email', redirectTo: 'confirmar-email', pathMatch: 'full' },

                    {
                      path: 'enviar-codigo', component: SendTwoFactorCodeComponent, data: {
                        meta: {
                          title: 'Worbby',
                          description: ''
                        }
                    ...
                    { path: 'send-code', redirectTo: 'enviar-codigo', pathMatch: 'full' },

                    {
                      path: 'codigo-verificacao', component: ValidateTwoFactorCodeComponent, data: {
                        meta: {
                          title: 'Worbby',
                          description: ''
                        }
                    ...
                    { path: 'verify-code', redirectTo: 'codigo-verificacao', pathMatch: 'full' },
